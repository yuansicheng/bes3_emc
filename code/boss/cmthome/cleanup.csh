...
${CMTROOT}/mgr/cmt cleanup -csh -pack=cmt_standalone -version=v0 -path=/junofs/users/yuansc/bes3_emc/code/boss/cmthome  $* >${cmtcmt_standalonetempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt cleanup -csh -pack=cmt_standalone -version=v0 -path=/junofs/users/yuansc/bes3_emc/code/boss/cmthome  $* >${cmtcmt_standalonetempfile}"
