...
#cmt_local_tagfile = $(ExtractEmcInfo_tag).make
cmt_local_tagfile = $(bin)$(ExtractEmcInfo_tag).make
...
cmt_local_setup_ExtractEmcInfoLib = $(bin)setup_ExtractEmcInfoLib$$$$.make
...
ExtractEmcInfoLib_extratags = -tag_add=target_ExtractEmcInfoLib

#$(cmt_local_tagfile_ExtractEmcInfoLib) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_ExtractEmcInfoLib) ::
else
$(cmt_local_tagfile_ExtractEmcInfoLib) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_ExtractEmcInfoLib); then /bin/rm -f $(cmt_local_tagfile_ExtractEmcInfoLib); fi ; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfoLib_extratags) build tag_makefile >>$(cmt_local_tagfile_ExtractEmcInfoLib)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_ExtractEmcInfoLib)"; \
	  test ! -f $(cmt_local_setup_ExtractEmcInfoLib) || \rm -f $(cmt_local_setup_ExtractEmcInfoLib); \
	  trap '\rm -f $(cmt_local_setup_ExtractEmcInfoLib)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfoLib_extratags) show setup >$(cmt_local_setup_ExtractEmcInfoLib) && \
	  if [ -f $(cmt_final_setup_ExtractEmcInfoLib) ] && \
	    \cmp -s $(cmt_final_setup_ExtractEmcInfoLib) $(cmt_local_setup_ExtractEmcInfoLib); then \
	    \rm $(cmt_local_setup_ExtractEmcInfoLib); else \
	    \mv -f $(cmt_local_setup_ExtractEmcInfoLib) $(cmt_final_setup_ExtractEmcInfoLib); fi
...
not_ExtractEmcInfoLib_dependencies = { n=0; for p in $?; do m=0; for d in $(ExtractEmcInfoLib_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
ExtractEmcInfoLibdirs :
	@if test ! -d $(bin)ExtractEmcInfoLib; then $(mkdir) -p $(bin)ExtractEmcInfoLib; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)ExtractEmcInfoLib
else
ExtractEmcInfoLibdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)ExtractEmcInfoLib
#
#$(cmt_local_ExtractEmcInfoLib_makefile) :: $(ExtractEmcInfoLib_dependencies) $(cmt_local_tagfile_ExtractEmcInfoLib) build_library_links dirs ExtractEmcInfoLibdirs
#else
#$(cmt_local_ExtractEmcInfoLib_makefile) :: $(ExtractEmcInfoLib_dependencies) $(cmt_local_tagfile_ExtractEmcInfoLib) build_library_links dirs
#endif
#else
#$(cmt_local_ExtractEmcInfoLib_makefile) :: $(cmt_local_tagfile_ExtractEmcInfoLib)
#endif

ifdef cmt_ExtractEmcInfoLib_has_target_tag

ifndef QUICK
$(cmt_local_ExtractEmcInfoLib_makefile) : $(ExtractEmcInfoLib_dependencies) build_library_links
	$(echo) "(constituents.make) Building ExtractEmcInfoLib.make"; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfoLib_extratags) build constituent_config -out=$(cmt_local_ExtractEmcInfoLib_makefile) ExtractEmcInfoLib
else
$(cmt_local_ExtractEmcInfoLib_makefile) : $(ExtractEmcInfoLib_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ExtractEmcInfoLib) ] || \
	  [ ! -f $(cmt_final_setup_ExtractEmcInfoLib) ] || \
	  $(not_ExtractEmcInfoLib_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building ExtractEmcInfoLib.make"; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfoLib_extratags) build constituent_config -out=$(cmt_local_ExtractEmcInfoLib_makefile) ExtractEmcInfoLib; \
	  fi
endif
...
$(cmt_local_ExtractEmcInfoLib_makefile) : $(ExtractEmcInfoLib_dependencies) build_library_links
	$(echo) "(constituents.make) Building ExtractEmcInfoLib.make"; \
	  $(cmtexe) -f=$(bin)ExtractEmcInfoLib.in -tag=$(tags) $(ExtractEmcInfoLib_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_ExtractEmcInfoLib_makefile) ExtractEmcInfoLib
else
$(cmt_local_ExtractEmcInfoLib_makefile) : $(ExtractEmcInfoLib_dependencies) $(cmt_build_library_linksstamp) $(bin)ExtractEmcInfoLib.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ExtractEmcInfoLib) ] || \
	  [ ! -f $(cmt_final_setup_ExtractEmcInfoLib) ] || \
	  $(not_ExtractEmcInfoLib_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfoLib_extratags) build constituent_makefile -out=$(cmt_local_ExtractEmcInfoLib_makefile) ExtractEmcInfoLib

ExtractEmcInfoLib :: $(ExtractEmcInfoLib_dependencies) $(cmt_local_ExtractEmcInfoLib_makefile) dirs ExtractEmcInfoLibdirs
	$(echo) "(constituents.make) Starting ExtractEmcInfoLib"
	@if test -f $(cmt_local_ExtractEmcInfoLib_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfoLib_makefile) ExtractEmcInfoLib; \
	  fi
#	@$(MAKE) -f $(cmt_local_ExtractEmcInfoLib_makefile) ExtractEmcInfoLib
	$(echo) "(constituents.make) ExtractEmcInfoLib done"

clean :: ExtractEmcInfoLibclean

ExtractEmcInfoLibclean :: $(ExtractEmcInfoLibclean_dependencies) ##$(cmt_local_ExtractEmcInfoLib_makefile)
	$(echo) "(constituents.make) Starting ExtractEmcInfoLibclean"
	@-if test -f $(cmt_local_ExtractEmcInfoLib_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfoLib_makefile) ExtractEmcInfoLibclean; \
	fi
	$(echo) "(constituents.make) ExtractEmcInfoLibclean done"
#	@-$(MAKE) -f $(cmt_local_ExtractEmcInfoLib_makefile) ExtractEmcInfoLibclean

##	  /bin/rm -f $(cmt_local_ExtractEmcInfoLib_makefile) $(bin)ExtractEmcInfoLib_dependencies.make

install :: ExtractEmcInfoLibinstall

ExtractEmcInfoLibinstall :: $(ExtractEmcInfoLib_dependencies) $(cmt_local_ExtractEmcInfoLib_makefile)
	$(echo) "(constituents.make) Starting install ExtractEmcInfoLib"
	@-$(MAKE) -f $(cmt_local_ExtractEmcInfoLib_makefile) install
	$(echo) "(constituents.make) install ExtractEmcInfoLib done"

uninstall : ExtractEmcInfoLibuninstall

$(foreach d,$(ExtractEmcInfoLib_dependencies),$(eval $(d)uninstall_dependencies += ExtractEmcInfoLibuninstall))

ExtractEmcInfoLibuninstall : $(ExtractEmcInfoLibuninstall_dependencies) ##$(cmt_local_ExtractEmcInfoLib_makefile)
	$(echo) "(constituents.make) Starting uninstall ExtractEmcInfoLib"
	@if test -f $(cmt_local_ExtractEmcInfoLib_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfoLib_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_ExtractEmcInfoLib_makefile) uninstall
	$(echo) "(constituents.make) uninstall ExtractEmcInfoLib done"

remove_library_links :: ExtractEmcInfoLibuninstall
...
cmt_local_setup_ExtractEmcInfo = $(bin)setup_ExtractEmcInfo$$$$.make
...
ExtractEmcInfo_extratags = -tag_add=target_ExtractEmcInfo

#$(cmt_local_tagfile_ExtractEmcInfo) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_ExtractEmcInfo) ::
else
$(cmt_local_tagfile_ExtractEmcInfo) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_ExtractEmcInfo); then /bin/rm -f $(cmt_local_tagfile_ExtractEmcInfo); fi ; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_extratags) build tag_makefile >>$(cmt_local_tagfile_ExtractEmcInfo)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_ExtractEmcInfo)"; \
	  test ! -f $(cmt_local_setup_ExtractEmcInfo) || \rm -f $(cmt_local_setup_ExtractEmcInfo); \
	  trap '\rm -f $(cmt_local_setup_ExtractEmcInfo)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_extratags) show setup >$(cmt_local_setup_ExtractEmcInfo) && \
	  if [ -f $(cmt_final_setup_ExtractEmcInfo) ] && \
	    \cmp -s $(cmt_final_setup_ExtractEmcInfo) $(cmt_local_setup_ExtractEmcInfo); then \
	    \rm $(cmt_local_setup_ExtractEmcInfo); else \
	    \mv -f $(cmt_local_setup_ExtractEmcInfo) $(cmt_final_setup_ExtractEmcInfo); fi
...
not_ExtractEmcInfo_dependencies = { n=0; for p in $?; do m=0; for d in $(ExtractEmcInfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
ExtractEmcInfodirs :
	@if test ! -d $(bin)ExtractEmcInfo; then $(mkdir) -p $(bin)ExtractEmcInfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)ExtractEmcInfo
else
ExtractEmcInfodirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)ExtractEmcInfo
#
#$(cmt_local_ExtractEmcInfo_makefile) :: $(ExtractEmcInfo_dependencies) $(cmt_local_tagfile_ExtractEmcInfo) build_library_links dirs ExtractEmcInfodirs
#else
#$(cmt_local_ExtractEmcInfo_makefile) :: $(ExtractEmcInfo_dependencies) $(cmt_local_tagfile_ExtractEmcInfo) build_library_links dirs
#endif
#else
#$(cmt_local_ExtractEmcInfo_makefile) :: $(cmt_local_tagfile_ExtractEmcInfo)
#endif

ifdef cmt_ExtractEmcInfo_has_target_tag

ifndef QUICK
$(cmt_local_ExtractEmcInfo_makefile) : $(ExtractEmcInfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building ExtractEmcInfo.make"; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_extratags) build constituent_config -out=$(cmt_local_ExtractEmcInfo_makefile) ExtractEmcInfo
else
$(cmt_local_ExtractEmcInfo_makefile) : $(ExtractEmcInfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ExtractEmcInfo) ] || \
	  [ ! -f $(cmt_final_setup_ExtractEmcInfo) ] || \
	  $(not_ExtractEmcInfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building ExtractEmcInfo.make"; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_extratags) build constituent_config -out=$(cmt_local_ExtractEmcInfo_makefile) ExtractEmcInfo; \
	  fi
endif
...
$(cmt_local_ExtractEmcInfo_makefile) : $(ExtractEmcInfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building ExtractEmcInfo.make"; \
	  $(cmtexe) -f=$(bin)ExtractEmcInfo.in -tag=$(tags) $(ExtractEmcInfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_ExtractEmcInfo_makefile) ExtractEmcInfo
else
$(cmt_local_ExtractEmcInfo_makefile) : $(ExtractEmcInfo_dependencies) $(cmt_build_library_linksstamp) $(bin)ExtractEmcInfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ExtractEmcInfo) ] || \
	  [ ! -f $(cmt_final_setup_ExtractEmcInfo) ] || \
	  $(not_ExtractEmcInfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_extratags) build constituent_makefile -out=$(cmt_local_ExtractEmcInfo_makefile) ExtractEmcInfo

ExtractEmcInfo :: $(ExtractEmcInfo_dependencies) $(cmt_local_ExtractEmcInfo_makefile) dirs ExtractEmcInfodirs
	$(echo) "(constituents.make) Starting ExtractEmcInfo"
	@if test -f $(cmt_local_ExtractEmcInfo_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfo_makefile) ExtractEmcInfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_ExtractEmcInfo_makefile) ExtractEmcInfo
	$(echo) "(constituents.make) ExtractEmcInfo done"

clean :: ExtractEmcInfoclean

ExtractEmcInfoclean :: $(ExtractEmcInfoclean_dependencies) ##$(cmt_local_ExtractEmcInfo_makefile)
	$(echo) "(constituents.make) Starting ExtractEmcInfoclean"
	@-if test -f $(cmt_local_ExtractEmcInfo_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfo_makefile) ExtractEmcInfoclean; \
	fi
	$(echo) "(constituents.make) ExtractEmcInfoclean done"
#	@-$(MAKE) -f $(cmt_local_ExtractEmcInfo_makefile) ExtractEmcInfoclean

##	  /bin/rm -f $(cmt_local_ExtractEmcInfo_makefile) $(bin)ExtractEmcInfo_dependencies.make

install :: ExtractEmcInfoinstall

ExtractEmcInfoinstall :: $(ExtractEmcInfo_dependencies) $(cmt_local_ExtractEmcInfo_makefile)
	$(echo) "(constituents.make) Starting install ExtractEmcInfo"
	@-$(MAKE) -f $(cmt_local_ExtractEmcInfo_makefile) install
	$(echo) "(constituents.make) install ExtractEmcInfo done"

uninstall : ExtractEmcInfouninstall

$(foreach d,$(ExtractEmcInfo_dependencies),$(eval $(d)uninstall_dependencies += ExtractEmcInfouninstall))

ExtractEmcInfouninstall : $(ExtractEmcInfouninstall_dependencies) ##$(cmt_local_ExtractEmcInfo_makefile)
	$(echo) "(constituents.make) Starting uninstall ExtractEmcInfo"
	@if test -f $(cmt_local_ExtractEmcInfo_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_ExtractEmcInfo_makefile) uninstall
	$(echo) "(constituents.make) uninstall ExtractEmcInfo done"

remove_library_links :: ExtractEmcInfouninstall
...
#cmt_local_tagfile_config = $(ExtractEmcInfo_tag)_config.make
cmt_local_tagfile_config = $(bin)$(ExtractEmcInfo_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)ExtractEmcInfo_configsetup.make
...
#cmt_local_tagfile_config = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_config = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)ExtractEmcInfosetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(ExtractEmcInfo_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(ExtractEmcInfo_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)ExtractEmcInfo_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_install_includes = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)ExtractEmcInfosetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(ExtractEmcInfo_tag)_make.make
cmt_local_tagfile_make = $(bin)$(ExtractEmcInfo_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)ExtractEmcInfo_makesetup.make
...
#cmt_local_tagfile_make = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_make = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)ExtractEmcInfosetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(ExtractEmcInfo_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(ExtractEmcInfo_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)ExtractEmcInfo_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)ExtractEmcInfosetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(ExtractEmcInfo_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(ExtractEmcInfo_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)ExtractEmcInfo_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)ExtractEmcInfosetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(ExtractEmcInfo_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(ExtractEmcInfo_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)ExtractEmcInfo_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)ExtractEmcInfosetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(ExtractEmcInfo_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(ExtractEmcInfo_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)ExtractEmcInfo_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)ExtractEmcInfosetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(ExtractEmcInfo_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(ExtractEmcInfo_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)ExtractEmcInfo_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_TestProject = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)ExtractEmcInfosetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(ExtractEmcInfo_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(ExtractEmcInfo_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)ExtractEmcInfo_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)ExtractEmcInfosetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(ExtractEmcInfo_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(ExtractEmcInfo_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)ExtractEmcInfo_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(ExtractEmcInfo_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(ExtractEmcInfo_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)ExtractEmcInfosetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_ExtractEmcInfo_check_install_runtime = $(bin)setup_ExtractEmcInfo_check_install_runtime$$$$.make
...
ExtractEmcInfo_check_install_runtime_extratags = -tag_add=target_ExtractEmcInfo_check_install_runtime

#$(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime) ::
else
$(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_ExtractEmcInfo_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_ExtractEmcInfo_check_install_runtime) || \rm -f $(cmt_local_setup_ExtractEmcInfo_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_ExtractEmcInfo_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_check_install_runtime_extratags) show setup >$(cmt_local_setup_ExtractEmcInfo_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_ExtractEmcInfo_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_ExtractEmcInfo_check_install_runtime) $(cmt_local_setup_ExtractEmcInfo_check_install_runtime); then \
	    \rm $(cmt_local_setup_ExtractEmcInfo_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_ExtractEmcInfo_check_install_runtime) $(cmt_final_setup_ExtractEmcInfo_check_install_runtime); fi
...
not_ExtractEmcInfo_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(ExtractEmcInfo_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
ExtractEmcInfo_check_install_runtimedirs :
	@if test ! -d $(bin)ExtractEmcInfo_check_install_runtime; then $(mkdir) -p $(bin)ExtractEmcInfo_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)ExtractEmcInfo_check_install_runtime
else
ExtractEmcInfo_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)ExtractEmcInfo_check_install_runtime
#
#$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) :: $(ExtractEmcInfo_check_install_runtime_dependencies) $(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime) build_library_links dirs ExtractEmcInfo_check_install_runtimedirs
#else
#$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) :: $(ExtractEmcInfo_check_install_runtime_dependencies) $(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) :: $(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime)
#endif

ifdef cmt_ExtractEmcInfo_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) : $(ExtractEmcInfo_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building ExtractEmcInfo_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) ExtractEmcInfo_check_install_runtime
else
$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) : $(ExtractEmcInfo_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_ExtractEmcInfo_check_install_runtime) ] || \
	  $(not_ExtractEmcInfo_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building ExtractEmcInfo_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) ExtractEmcInfo_check_install_runtime; \
	  fi
endif
...
$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) : $(ExtractEmcInfo_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building ExtractEmcInfo_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)ExtractEmcInfo_check_install_runtime.in -tag=$(tags) $(ExtractEmcInfo_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) ExtractEmcInfo_check_install_runtime
else
$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) : $(ExtractEmcInfo_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)ExtractEmcInfo_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ExtractEmcInfo_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_ExtractEmcInfo_check_install_runtime) ] || \
	  $(not_ExtractEmcInfo_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(ExtractEmcInfo_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) ExtractEmcInfo_check_install_runtime

ExtractEmcInfo_check_install_runtime :: $(ExtractEmcInfo_check_install_runtime_dependencies) $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) dirs ExtractEmcInfo_check_install_runtimedirs
	$(echo) "(constituents.make) Starting ExtractEmcInfo_check_install_runtime"
	@if test -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) ExtractEmcInfo_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) ExtractEmcInfo_check_install_runtime
	$(echo) "(constituents.make) ExtractEmcInfo_check_install_runtime done"

clean :: ExtractEmcInfo_check_install_runtimeclean

ExtractEmcInfo_check_install_runtimeclean :: $(ExtractEmcInfo_check_install_runtimeclean_dependencies) ##$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting ExtractEmcInfo_check_install_runtimeclean"
	@-if test -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) ExtractEmcInfo_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) ExtractEmcInfo_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) ExtractEmcInfo_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) $(bin)ExtractEmcInfo_check_install_runtime_dependencies.make

install :: ExtractEmcInfo_check_install_runtimeinstall

ExtractEmcInfo_check_install_runtimeinstall :: $(ExtractEmcInfo_check_install_runtime_dependencies) $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install ExtractEmcInfo_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install ExtractEmcInfo_check_install_runtime done"

uninstall : ExtractEmcInfo_check_install_runtimeuninstall

$(foreach d,$(ExtractEmcInfo_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += ExtractEmcInfo_check_install_runtimeuninstall))

ExtractEmcInfo_check_install_runtimeuninstall : $(ExtractEmcInfo_check_install_runtimeuninstall_dependencies) ##$(cmt_local_ExtractEmcInfo_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall ExtractEmcInfo_check_install_runtime"
	@if test -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_ExtractEmcInfo_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall ExtractEmcInfo_check_install_runtime done"

remove_library_links :: ExtractEmcInfo_check_install_runtimeuninstall
