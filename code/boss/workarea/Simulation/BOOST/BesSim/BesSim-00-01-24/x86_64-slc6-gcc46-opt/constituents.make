...
#cmt_local_tagfile = $(BesSim_tag).make
cmt_local_tagfile = $(bin)$(BesSim_tag).make
...
cmt_local_setup_BesSim = $(bin)setup_BesSim$$$$.make
...
BesSim_extratags = -tag_add=target_BesSim

#$(cmt_local_tagfile_BesSim) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_BesSim) ::
else
$(cmt_local_tagfile_BesSim) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_BesSim); then /bin/rm -f $(cmt_local_tagfile_BesSim); fi ; \
	  $(cmtexe) -tag=$(tags) $(BesSim_extratags) build tag_makefile >>$(cmt_local_tagfile_BesSim)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_BesSim)"; \
	  test ! -f $(cmt_local_setup_BesSim) || \rm -f $(cmt_local_setup_BesSim); \
	  trap '\rm -f $(cmt_local_setup_BesSim)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(BesSim_extratags) show setup >$(cmt_local_setup_BesSim) && \
	  if [ -f $(cmt_final_setup_BesSim) ] && \
	    \cmp -s $(cmt_final_setup_BesSim) $(cmt_local_setup_BesSim); then \
	    \rm $(cmt_local_setup_BesSim); else \
	    \mv -f $(cmt_local_setup_BesSim) $(cmt_final_setup_BesSim); fi
...
not_BesSim_dependencies = { n=0; for p in $?; do m=0; for d in $(BesSim_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
BesSimdirs :
	@if test ! -d $(bin)BesSim; then $(mkdir) -p $(bin)BesSim; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)BesSim
else
BesSimdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)BesSim
#
#$(cmt_local_BesSim_makefile) :: $(BesSim_dependencies) $(cmt_local_tagfile_BesSim) build_library_links dirs BesSimdirs
#else
#$(cmt_local_BesSim_makefile) :: $(BesSim_dependencies) $(cmt_local_tagfile_BesSim) build_library_links dirs
#endif
#else
#$(cmt_local_BesSim_makefile) :: $(cmt_local_tagfile_BesSim)
#endif

ifdef cmt_BesSim_has_target_tag

ifndef QUICK
$(cmt_local_BesSim_makefile) : $(BesSim_dependencies) build_library_links
	$(echo) "(constituents.make) Building BesSim.make"; \
	  $(cmtexe) -tag=$(tags) $(BesSim_extratags) build constituent_config -out=$(cmt_local_BesSim_makefile) BesSim
else
$(cmt_local_BesSim_makefile) : $(BesSim_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_BesSim) ] || \
	  [ ! -f $(cmt_final_setup_BesSim) ] || \
	  $(not_BesSim_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building BesSim.make"; \
	  $(cmtexe) -tag=$(tags) $(BesSim_extratags) build constituent_config -out=$(cmt_local_BesSim_makefile) BesSim; \
	  fi
endif
...
$(cmt_local_BesSim_makefile) : $(BesSim_dependencies) build_library_links
	$(echo) "(constituents.make) Building BesSim.make"; \
	  $(cmtexe) -f=$(bin)BesSim.in -tag=$(tags) $(BesSim_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_BesSim_makefile) BesSim
else
$(cmt_local_BesSim_makefile) : $(BesSim_dependencies) $(cmt_build_library_linksstamp) $(bin)BesSim.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_BesSim) ] || \
	  [ ! -f $(cmt_final_setup_BesSim) ] || \
	  $(not_BesSim_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(BesSim_extratags) build constituent_makefile -out=$(cmt_local_BesSim_makefile) BesSim

BesSim :: $(BesSim_dependencies) $(cmt_local_BesSim_makefile) dirs BesSimdirs
	$(echo) "(constituents.make) Starting BesSim"
	@if test -f $(cmt_local_BesSim_makefile); then \
	  $(MAKE) -f $(cmt_local_BesSim_makefile) BesSim; \
	  fi
#	@$(MAKE) -f $(cmt_local_BesSim_makefile) BesSim
	$(echo) "(constituents.make) BesSim done"

clean :: BesSimclean

BesSimclean :: $(BesSimclean_dependencies) ##$(cmt_local_BesSim_makefile)
	$(echo) "(constituents.make) Starting BesSimclean"
	@-if test -f $(cmt_local_BesSim_makefile); then \
	  $(MAKE) -f $(cmt_local_BesSim_makefile) BesSimclean; \
	fi
	$(echo) "(constituents.make) BesSimclean done"
#	@-$(MAKE) -f $(cmt_local_BesSim_makefile) BesSimclean

##	  /bin/rm -f $(cmt_local_BesSim_makefile) $(bin)BesSim_dependencies.make

install :: BesSiminstall

BesSiminstall :: $(BesSim_dependencies) $(cmt_local_BesSim_makefile)
	$(echo) "(constituents.make) Starting install BesSim"
	@-$(MAKE) -f $(cmt_local_BesSim_makefile) install
	$(echo) "(constituents.make) install BesSim done"

uninstall : BesSimuninstall

$(foreach d,$(BesSim_dependencies),$(eval $(d)uninstall_dependencies += BesSimuninstall))

BesSimuninstall : $(BesSimuninstall_dependencies) ##$(cmt_local_BesSim_makefile)
	$(echo) "(constituents.make) Starting uninstall BesSim"
	@if test -f $(cmt_local_BesSim_makefile); then \
	  $(MAKE) -f $(cmt_local_BesSim_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_BesSim_makefile) uninstall
	$(echo) "(constituents.make) uninstall BesSim done"

remove_library_links :: BesSimuninstall
...
#cmt_local_tagfile_make = $(BesSim_tag)_make.make
cmt_local_tagfile_make = $(bin)$(BesSim_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)BesSim_makesetup.make
...
#cmt_local_tagfile_make = $(BesSim_tag).make
cmt_local_tagfile_make = $(bin)$(BesSim_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)BesSimsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(BesSim_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(BesSim_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)BesSim_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(BesSim_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(BesSim_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)BesSimsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(BesSim_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(BesSim_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)BesSim_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(BesSim_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(BesSim_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)BesSimsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(BesSim_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(BesSim_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)BesSim_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(BesSim_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(BesSim_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)BesSimsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(BesSim_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(BesSim_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)BesSim_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(BesSim_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(BesSim_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)BesSimsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(BesSim_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(BesSim_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)BesSim_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(BesSim_tag).make
cmt_local_tagfile_TestProject = $(bin)$(BesSim_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)BesSimsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(BesSim_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(BesSim_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)BesSim_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(BesSim_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(BesSim_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)BesSimsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(BesSim_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(BesSim_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)BesSim_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(BesSim_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(BesSim_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)BesSimsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(BesSim_tag)_EventNavigator_check_install_runtime.make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(BesSim_tag)_EventNavigator_check_install_runtime.make
...
#cmt_final_setup_EventNavigator_check_install_runtime = $(bin)BesSim_EventNavigator_check_install_runtimesetup.make
...
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(BesSim_tag).make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(BesSim_tag).make
cmt_final_setup_EventNavigator_check_install_runtime = $(bin)setup.make
#cmt_final_setup_EventNavigator_check_install_runtime = $(bin)BesSimsetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = $(bin)EventNavigator_check_install_runtime.make
