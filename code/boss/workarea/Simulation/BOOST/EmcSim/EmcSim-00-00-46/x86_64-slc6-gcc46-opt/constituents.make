...
#cmt_local_tagfile = $(EmcSim_tag).make
cmt_local_tagfile = $(bin)$(EmcSim_tag).make
...
cmt_local_setup_EmcSim = $(bin)setup_EmcSim$$$$.make
...
EmcSim_extratags = -tag_add=target_EmcSim

#$(cmt_local_tagfile_EmcSim) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_EmcSim) ::
else
$(cmt_local_tagfile_EmcSim) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_EmcSim); then /bin/rm -f $(cmt_local_tagfile_EmcSim); fi ; \
	  $(cmtexe) -tag=$(tags) $(EmcSim_extratags) build tag_makefile >>$(cmt_local_tagfile_EmcSim)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_EmcSim)"; \
	  test ! -f $(cmt_local_setup_EmcSim) || \rm -f $(cmt_local_setup_EmcSim); \
	  trap '\rm -f $(cmt_local_setup_EmcSim)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(EmcSim_extratags) show setup >$(cmt_local_setup_EmcSim) && \
	  if [ -f $(cmt_final_setup_EmcSim) ] && \
	    \cmp -s $(cmt_final_setup_EmcSim) $(cmt_local_setup_EmcSim); then \
	    \rm $(cmt_local_setup_EmcSim); else \
	    \mv -f $(cmt_local_setup_EmcSim) $(cmt_final_setup_EmcSim); fi
...
not_EmcSim_dependencies = { n=0; for p in $?; do m=0; for d in $(EmcSim_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
EmcSimdirs :
	@if test ! -d $(bin)EmcSim; then $(mkdir) -p $(bin)EmcSim; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)EmcSim
else
EmcSimdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)EmcSim
#
#$(cmt_local_EmcSim_makefile) :: $(EmcSim_dependencies) $(cmt_local_tagfile_EmcSim) build_library_links dirs EmcSimdirs
#else
#$(cmt_local_EmcSim_makefile) :: $(EmcSim_dependencies) $(cmt_local_tagfile_EmcSim) build_library_links dirs
#endif
#else
#$(cmt_local_EmcSim_makefile) :: $(cmt_local_tagfile_EmcSim)
#endif

ifdef cmt_EmcSim_has_target_tag

ifndef QUICK
$(cmt_local_EmcSim_makefile) : $(EmcSim_dependencies) build_library_links
	$(echo) "(constituents.make) Building EmcSim.make"; \
	  $(cmtexe) -tag=$(tags) $(EmcSim_extratags) build constituent_config -out=$(cmt_local_EmcSim_makefile) EmcSim
else
$(cmt_local_EmcSim_makefile) : $(EmcSim_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_EmcSim) ] || \
	  [ ! -f $(cmt_final_setup_EmcSim) ] || \
	  $(not_EmcSim_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building EmcSim.make"; \
	  $(cmtexe) -tag=$(tags) $(EmcSim_extratags) build constituent_config -out=$(cmt_local_EmcSim_makefile) EmcSim; \
	  fi
endif
...
$(cmt_local_EmcSim_makefile) : $(EmcSim_dependencies) build_library_links
	$(echo) "(constituents.make) Building EmcSim.make"; \
	  $(cmtexe) -f=$(bin)EmcSim.in -tag=$(tags) $(EmcSim_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_EmcSim_makefile) EmcSim
else
$(cmt_local_EmcSim_makefile) : $(EmcSim_dependencies) $(cmt_build_library_linksstamp) $(bin)EmcSim.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_EmcSim) ] || \
	  [ ! -f $(cmt_final_setup_EmcSim) ] || \
	  $(not_EmcSim_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(EmcSim_extratags) build constituent_makefile -out=$(cmt_local_EmcSim_makefile) EmcSim

EmcSim :: $(EmcSim_dependencies) $(cmt_local_EmcSim_makefile) dirs EmcSimdirs
	$(echo) "(constituents.make) Starting EmcSim"
	@if test -f $(cmt_local_EmcSim_makefile); then \
	  $(MAKE) -f $(cmt_local_EmcSim_makefile) EmcSim; \
	  fi
#	@$(MAKE) -f $(cmt_local_EmcSim_makefile) EmcSim
	$(echo) "(constituents.make) EmcSim done"

clean :: EmcSimclean

EmcSimclean :: $(EmcSimclean_dependencies) ##$(cmt_local_EmcSim_makefile)
	$(echo) "(constituents.make) Starting EmcSimclean"
	@-if test -f $(cmt_local_EmcSim_makefile); then \
	  $(MAKE) -f $(cmt_local_EmcSim_makefile) EmcSimclean; \
	fi
	$(echo) "(constituents.make) EmcSimclean done"
#	@-$(MAKE) -f $(cmt_local_EmcSim_makefile) EmcSimclean

##	  /bin/rm -f $(cmt_local_EmcSim_makefile) $(bin)EmcSim_dependencies.make

install :: EmcSiminstall

EmcSiminstall :: $(EmcSim_dependencies) $(cmt_local_EmcSim_makefile)
	$(echo) "(constituents.make) Starting install EmcSim"
	@-$(MAKE) -f $(cmt_local_EmcSim_makefile) install
	$(echo) "(constituents.make) install EmcSim done"

uninstall : EmcSimuninstall

$(foreach d,$(EmcSim_dependencies),$(eval $(d)uninstall_dependencies += EmcSimuninstall))

EmcSimuninstall : $(EmcSimuninstall_dependencies) ##$(cmt_local_EmcSim_makefile)
	$(echo) "(constituents.make) Starting uninstall EmcSim"
	@if test -f $(cmt_local_EmcSim_makefile); then \
	  $(MAKE) -f $(cmt_local_EmcSim_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_EmcSim_makefile) uninstall
	$(echo) "(constituents.make) uninstall EmcSim done"

remove_library_links :: EmcSimuninstall
...
#cmt_local_tagfile_make = $(EmcSim_tag)_make.make
cmt_local_tagfile_make = $(bin)$(EmcSim_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)EmcSim_makesetup.make
...
#cmt_local_tagfile_make = $(EmcSim_tag).make
cmt_local_tagfile_make = $(bin)$(EmcSim_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)EmcSimsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(EmcSim_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(EmcSim_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)EmcSim_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(EmcSim_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(EmcSim_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)EmcSimsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(EmcSim_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(EmcSim_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)EmcSim_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(EmcSim_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(EmcSim_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)EmcSimsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(EmcSim_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(EmcSim_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)EmcSim_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(EmcSim_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(EmcSim_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)EmcSimsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(EmcSim_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(EmcSim_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)EmcSim_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(EmcSim_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(EmcSim_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)EmcSimsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(EmcSim_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(EmcSim_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)EmcSim_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(EmcSim_tag).make
cmt_local_tagfile_TestProject = $(bin)$(EmcSim_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)EmcSimsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(EmcSim_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(EmcSim_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)EmcSim_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(EmcSim_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(EmcSim_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)EmcSimsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(EmcSim_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(EmcSim_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)EmcSim_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(EmcSim_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(EmcSim_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)EmcSimsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
