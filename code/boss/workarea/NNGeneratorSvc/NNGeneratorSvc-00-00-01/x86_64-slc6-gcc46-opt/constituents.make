...
#cmt_local_tagfile = $(NNGeneratorSvc_tag).make
cmt_local_tagfile = $(bin)$(NNGeneratorSvc_tag).make
...
cmt_local_setup_NNGeneratorSvcLib = $(bin)setup_NNGeneratorSvcLib$$$$.make
...
NNGeneratorSvcLib_extratags = -tag_add=target_NNGeneratorSvcLib

#$(cmt_local_tagfile_NNGeneratorSvcLib) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_NNGeneratorSvcLib) ::
else
$(cmt_local_tagfile_NNGeneratorSvcLib) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_NNGeneratorSvcLib); then /bin/rm -f $(cmt_local_tagfile_NNGeneratorSvcLib); fi ; \
	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvcLib_extratags) build tag_makefile >>$(cmt_local_tagfile_NNGeneratorSvcLib)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_NNGeneratorSvcLib)"; \
	  test ! -f $(cmt_local_setup_NNGeneratorSvcLib) || \rm -f $(cmt_local_setup_NNGeneratorSvcLib); \
	  trap '\rm -f $(cmt_local_setup_NNGeneratorSvcLib)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvcLib_extratags) show setup >$(cmt_local_setup_NNGeneratorSvcLib) && \
	  if [ -f $(cmt_final_setup_NNGeneratorSvcLib) ] && \
	    \cmp -s $(cmt_final_setup_NNGeneratorSvcLib) $(cmt_local_setup_NNGeneratorSvcLib); then \
	    \rm $(cmt_local_setup_NNGeneratorSvcLib); else \
	    \mv -f $(cmt_local_setup_NNGeneratorSvcLib) $(cmt_final_setup_NNGeneratorSvcLib); fi
...
not_NNGeneratorSvcLib_dependencies = { n=0; for p in $?; do m=0; for d in $(NNGeneratorSvcLib_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
NNGeneratorSvcLibdirs :
	@if test ! -d $(bin)NNGeneratorSvcLib; then $(mkdir) -p $(bin)NNGeneratorSvcLib; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)NNGeneratorSvcLib
else
NNGeneratorSvcLibdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)NNGeneratorSvcLib
#
#$(cmt_local_NNGeneratorSvcLib_makefile) :: $(NNGeneratorSvcLib_dependencies) $(cmt_local_tagfile_NNGeneratorSvcLib) build_library_links dirs NNGeneratorSvcLibdirs
#else
#$(cmt_local_NNGeneratorSvcLib_makefile) :: $(NNGeneratorSvcLib_dependencies) $(cmt_local_tagfile_NNGeneratorSvcLib) build_library_links dirs
#endif
#else
#$(cmt_local_NNGeneratorSvcLib_makefile) :: $(cmt_local_tagfile_NNGeneratorSvcLib)
#endif

ifdef cmt_NNGeneratorSvcLib_has_target_tag

ifndef QUICK
$(cmt_local_NNGeneratorSvcLib_makefile) : $(NNGeneratorSvcLib_dependencies) build_library_links
	$(echo) "(constituents.make) Building NNGeneratorSvcLib.make"; \
	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvcLib_extratags) build constituent_config -out=$(cmt_local_NNGeneratorSvcLib_makefile) NNGeneratorSvcLib
else
$(cmt_local_NNGeneratorSvcLib_makefile) : $(NNGeneratorSvcLib_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_NNGeneratorSvcLib) ] || \
	  [ ! -f $(cmt_final_setup_NNGeneratorSvcLib) ] || \
	  $(not_NNGeneratorSvcLib_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building NNGeneratorSvcLib.make"; \
	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvcLib_extratags) build constituent_config -out=$(cmt_local_NNGeneratorSvcLib_makefile) NNGeneratorSvcLib; \
	  fi
endif
...
$(cmt_local_NNGeneratorSvcLib_makefile) : $(NNGeneratorSvcLib_dependencies) build_library_links
	$(echo) "(constituents.make) Building NNGeneratorSvcLib.make"; \
	  $(cmtexe) -f=$(bin)NNGeneratorSvcLib.in -tag=$(tags) $(NNGeneratorSvcLib_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_NNGeneratorSvcLib_makefile) NNGeneratorSvcLib
else
$(cmt_local_NNGeneratorSvcLib_makefile) : $(NNGeneratorSvcLib_dependencies) $(cmt_build_library_linksstamp) $(bin)NNGeneratorSvcLib.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_NNGeneratorSvcLib) ] || \
	  [ ! -f $(cmt_final_setup_NNGeneratorSvcLib) ] || \
	  $(not_NNGeneratorSvcLib_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvcLib_extratags) build constituent_makefile -out=$(cmt_local_NNGeneratorSvcLib_makefile) NNGeneratorSvcLib

NNGeneratorSvcLib :: $(NNGeneratorSvcLib_dependencies) $(cmt_local_NNGeneratorSvcLib_makefile) dirs NNGeneratorSvcLibdirs
	$(echo) "(constituents.make) Starting NNGeneratorSvcLib"
	@if test -f $(cmt_local_NNGeneratorSvcLib_makefile); then \
	  $(MAKE) -f $(cmt_local_NNGeneratorSvcLib_makefile) NNGeneratorSvcLib; \
	  fi
#	@$(MAKE) -f $(cmt_local_NNGeneratorSvcLib_makefile) NNGeneratorSvcLib
	$(echo) "(constituents.make) NNGeneratorSvcLib done"

clean :: NNGeneratorSvcLibclean

NNGeneratorSvcLibclean :: $(NNGeneratorSvcLibclean_dependencies) ##$(cmt_local_NNGeneratorSvcLib_makefile)
	$(echo) "(constituents.make) Starting NNGeneratorSvcLibclean"
	@-if test -f $(cmt_local_NNGeneratorSvcLib_makefile); then \
	  $(MAKE) -f $(cmt_local_NNGeneratorSvcLib_makefile) NNGeneratorSvcLibclean; \
	fi
	$(echo) "(constituents.make) NNGeneratorSvcLibclean done"
#	@-$(MAKE) -f $(cmt_local_NNGeneratorSvcLib_makefile) NNGeneratorSvcLibclean

##	  /bin/rm -f $(cmt_local_NNGeneratorSvcLib_makefile) $(bin)NNGeneratorSvcLib_dependencies.make

install :: NNGeneratorSvcLibinstall

NNGeneratorSvcLibinstall :: $(NNGeneratorSvcLib_dependencies) $(cmt_local_NNGeneratorSvcLib_makefile)
	$(echo) "(constituents.make) Starting install NNGeneratorSvcLib"
	@-$(MAKE) -f $(cmt_local_NNGeneratorSvcLib_makefile) install
	$(echo) "(constituents.make) install NNGeneratorSvcLib done"

uninstall : NNGeneratorSvcLibuninstall

$(foreach d,$(NNGeneratorSvcLib_dependencies),$(eval $(d)uninstall_dependencies += NNGeneratorSvcLibuninstall))

NNGeneratorSvcLibuninstall : $(NNGeneratorSvcLibuninstall_dependencies) ##$(cmt_local_NNGeneratorSvcLib_makefile)
	$(echo) "(constituents.make) Starting uninstall NNGeneratorSvcLib"
	@if test -f $(cmt_local_NNGeneratorSvcLib_makefile); then \
	  $(MAKE) -f $(cmt_local_NNGeneratorSvcLib_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_NNGeneratorSvcLib_makefile) uninstall
	$(echo) "(constituents.make) uninstall NNGeneratorSvcLib done"

remove_library_links :: NNGeneratorSvcLibuninstall
...
cmt_local_setup_NNGeneratorSvc = $(bin)setup_NNGeneratorSvc$$$$.make
...
NNGeneratorSvc_extratags = -tag_add=target_NNGeneratorSvc

#$(cmt_local_tagfile_NNGeneratorSvc) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_NNGeneratorSvc) ::
else
$(cmt_local_tagfile_NNGeneratorSvc) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_NNGeneratorSvc); then /bin/rm -f $(cmt_local_tagfile_NNGeneratorSvc); fi ; \
	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvc_extratags) build tag_makefile >>$(cmt_local_tagfile_NNGeneratorSvc)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_NNGeneratorSvc)"; \
	  test ! -f $(cmt_local_setup_NNGeneratorSvc) || \rm -f $(cmt_local_setup_NNGeneratorSvc); \
	  trap '\rm -f $(cmt_local_setup_NNGeneratorSvc)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvc_extratags) show setup >$(cmt_local_setup_NNGeneratorSvc) && \
	  if [ -f $(cmt_final_setup_NNGeneratorSvc) ] && \
	    \cmp -s $(cmt_final_setup_NNGeneratorSvc) $(cmt_local_setup_NNGeneratorSvc); then \
	    \rm $(cmt_local_setup_NNGeneratorSvc); else \
	    \mv -f $(cmt_local_setup_NNGeneratorSvc) $(cmt_final_setup_NNGeneratorSvc); fi
...
not_NNGeneratorSvc_dependencies = { n=0; for p in $?; do m=0; for d in $(NNGeneratorSvc_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
NNGeneratorSvcdirs :
	@if test ! -d $(bin)NNGeneratorSvc; then $(mkdir) -p $(bin)NNGeneratorSvc; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)NNGeneratorSvc
else
NNGeneratorSvcdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)NNGeneratorSvc
#
#$(cmt_local_NNGeneratorSvc_makefile) :: $(NNGeneratorSvc_dependencies) $(cmt_local_tagfile_NNGeneratorSvc) build_library_links dirs NNGeneratorSvcdirs
#else
#$(cmt_local_NNGeneratorSvc_makefile) :: $(NNGeneratorSvc_dependencies) $(cmt_local_tagfile_NNGeneratorSvc) build_library_links dirs
#endif
#else
#$(cmt_local_NNGeneratorSvc_makefile) :: $(cmt_local_tagfile_NNGeneratorSvc)
#endif

ifdef cmt_NNGeneratorSvc_has_target_tag

ifndef QUICK
$(cmt_local_NNGeneratorSvc_makefile) : $(NNGeneratorSvc_dependencies) build_library_links
	$(echo) "(constituents.make) Building NNGeneratorSvc.make"; \
	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvc_extratags) build constituent_config -out=$(cmt_local_NNGeneratorSvc_makefile) NNGeneratorSvc
else
$(cmt_local_NNGeneratorSvc_makefile) : $(NNGeneratorSvc_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_NNGeneratorSvc) ] || \
	  [ ! -f $(cmt_final_setup_NNGeneratorSvc) ] || \
	  $(not_NNGeneratorSvc_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building NNGeneratorSvc.make"; \
	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvc_extratags) build constituent_config -out=$(cmt_local_NNGeneratorSvc_makefile) NNGeneratorSvc; \
	  fi
endif
...
$(cmt_local_NNGeneratorSvc_makefile) : $(NNGeneratorSvc_dependencies) build_library_links
	$(echo) "(constituents.make) Building NNGeneratorSvc.make"; \
	  $(cmtexe) -f=$(bin)NNGeneratorSvc.in -tag=$(tags) $(NNGeneratorSvc_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_NNGeneratorSvc_makefile) NNGeneratorSvc
else
$(cmt_local_NNGeneratorSvc_makefile) : $(NNGeneratorSvc_dependencies) $(cmt_build_library_linksstamp) $(bin)NNGeneratorSvc.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_NNGeneratorSvc) ] || \
	  [ ! -f $(cmt_final_setup_NNGeneratorSvc) ] || \
	  $(not_NNGeneratorSvc_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(NNGeneratorSvc_extratags) build constituent_makefile -out=$(cmt_local_NNGeneratorSvc_makefile) NNGeneratorSvc

NNGeneratorSvc :: $(NNGeneratorSvc_dependencies) $(cmt_local_NNGeneratorSvc_makefile) dirs NNGeneratorSvcdirs
	$(echo) "(constituents.make) Starting NNGeneratorSvc"
	@if test -f $(cmt_local_NNGeneratorSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_NNGeneratorSvc_makefile) NNGeneratorSvc; \
	  fi
#	@$(MAKE) -f $(cmt_local_NNGeneratorSvc_makefile) NNGeneratorSvc
	$(echo) "(constituents.make) NNGeneratorSvc done"

clean :: NNGeneratorSvcclean

NNGeneratorSvcclean :: $(NNGeneratorSvcclean_dependencies) ##$(cmt_local_NNGeneratorSvc_makefile)
	$(echo) "(constituents.make) Starting NNGeneratorSvcclean"
	@-if test -f $(cmt_local_NNGeneratorSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_NNGeneratorSvc_makefile) NNGeneratorSvcclean; \
	fi
	$(echo) "(constituents.make) NNGeneratorSvcclean done"
#	@-$(MAKE) -f $(cmt_local_NNGeneratorSvc_makefile) NNGeneratorSvcclean

##	  /bin/rm -f $(cmt_local_NNGeneratorSvc_makefile) $(bin)NNGeneratorSvc_dependencies.make

install :: NNGeneratorSvcinstall

NNGeneratorSvcinstall :: $(NNGeneratorSvc_dependencies) $(cmt_local_NNGeneratorSvc_makefile)
	$(echo) "(constituents.make) Starting install NNGeneratorSvc"
	@-$(MAKE) -f $(cmt_local_NNGeneratorSvc_makefile) install
	$(echo) "(constituents.make) install NNGeneratorSvc done"

uninstall : NNGeneratorSvcuninstall

$(foreach d,$(NNGeneratorSvc_dependencies),$(eval $(d)uninstall_dependencies += NNGeneratorSvcuninstall))

NNGeneratorSvcuninstall : $(NNGeneratorSvcuninstall_dependencies) ##$(cmt_local_NNGeneratorSvc_makefile)
	$(echo) "(constituents.make) Starting uninstall NNGeneratorSvc"
	@if test -f $(cmt_local_NNGeneratorSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_NNGeneratorSvc_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_NNGeneratorSvc_makefile) uninstall
	$(echo) "(constituents.make) uninstall NNGeneratorSvc done"

remove_library_links :: NNGeneratorSvcuninstall
...
#cmt_local_tagfile_config = $(NNGeneratorSvc_tag)_config.make
cmt_local_tagfile_config = $(bin)$(NNGeneratorSvc_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)NNGeneratorSvc_configsetup.make
...
#cmt_local_tagfile_config = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_config = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)NNGeneratorSvcsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(NNGeneratorSvc_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(NNGeneratorSvc_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)NNGeneratorSvc_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_install_includes = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)NNGeneratorSvcsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(NNGeneratorSvc_tag)_make.make
cmt_local_tagfile_make = $(bin)$(NNGeneratorSvc_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)NNGeneratorSvc_makesetup.make
...
#cmt_local_tagfile_make = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_make = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)NNGeneratorSvcsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(NNGeneratorSvc_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(NNGeneratorSvc_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)NNGeneratorSvc_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)NNGeneratorSvcsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(NNGeneratorSvc_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(NNGeneratorSvc_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)NNGeneratorSvc_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)NNGeneratorSvcsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(NNGeneratorSvc_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(NNGeneratorSvc_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)NNGeneratorSvc_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)NNGeneratorSvcsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(NNGeneratorSvc_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(NNGeneratorSvc_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)NNGeneratorSvc_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)NNGeneratorSvcsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(NNGeneratorSvc_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(NNGeneratorSvc_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)NNGeneratorSvc_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_TestProject = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)NNGeneratorSvcsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(NNGeneratorSvc_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(NNGeneratorSvc_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)NNGeneratorSvc_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(NNGeneratorSvc_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(NNGeneratorSvc_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)NNGeneratorSvcsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
